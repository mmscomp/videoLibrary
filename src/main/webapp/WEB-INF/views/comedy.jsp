...
-->
   ...
   <a href= "/movie">Home</a>
     ...
     <div class="add-movie">
   <a href = "/movie/Comedy/add/">Add Movie</a> 
   </div>	
  </section>
...
<!--	 <img src="C:\Users\ARIGAP\Desktop\VS\images\thinking-girl.jpg">
	...
	<div class="film-title"><h1><span> COMEDY MOVIES </span></h1>
  	<div class="film-sub-title"> <h2>Select a movie</h2>
	<c:forEach items="${comedyMovie}" var="comedy">
	  <div id="vdo">
	   <div class="mov">
	   <div class="mov-1">
	   <div class="1">
	    <a href="${comedy.links}">${comedy.title}</a>
	    </div>
	    <div class="2">
	    <a href="/movie/Comedy/${comedy.id}/delete">Remove</a>
	    </div>
	    </div> 
	       <br>
	    <iframe src="${comedy.links}"></iframe>
