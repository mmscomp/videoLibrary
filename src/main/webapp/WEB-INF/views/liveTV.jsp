...
-->
   ...
   <a href= "/movie">Home</a>
     ...
     <div class="add-movie">
   <a href = "/movie/Action/add/">Add TV Channel</a> 
   </div>	
  </section>
...
<!--	 <img src="C:\Users\ARIGAP\Desktop\VS\images\thinking-girl.jpg">
	...
	<c:forEach items="${liveTVMovie}" var="liveTV">
	  <div id="vdo">
	   <div class="mov">
	   <div class="mov-1">
	   <div class="1">
	    <a href="${liveTV.links}">${liveTV.title}</a>
	    </div>
	    <div class="2">
	    <a href="/movie/LiveTV/${liveTV.id}/delete">Remove</a>
	    </div>
	    </div> 
	       <br>
	    <iframe src="${liveTV.links}"></iframe>
	    ...
	    <div id="view">
	    <a href=/log/${liveTV}/${liveTV.title}/${liveTV.id} >Write a review</a>
	 &emsp;&emsp;&emsp;   <a href=/movie/${liveTV}/${liveTV.title}/${liveTV.id}/views >View reviews</a>
	</div>
	</div>
