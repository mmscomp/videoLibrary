...
-->
   ...
   <a href= "/movie">Home</a>
     ...
     <div class="add-movie">
   <a href = "/movie/Drama/add/">Add Movie</a> 
   </div>	
  </section>
...
<!--	 <img src="C:\Users\ARIGAP\Desktop\VS\images\thinking-girl.jpg">
	...
	<div class="film-title"><h1><span> DRAMA MOVIES </span></h1>
  	<div class="film-sub-title"> <h2>Select a movie</h2>
	<c:forEach items="${dramaMovie}" var="drama">
	  <div id="vdo">
	   <div class="mov">
	   <div class="mov-1">
	   <div class="1">
	    <a href="${drama.links}">${drama.title}</a>
	    </div>
	    <div class="2">
	    <a href="/movie/Drama/${drama.id}/delete">Remove</a>
	    </div>
	    </div> 
	       <br>
	    <iframe src="${drama.links}"></iframe>
	    ...
	    <div id="view">
	    <a href="/log/Drama/${drama.title}/${drama.id}">Write a review</a>
	 &emsp;&emsp;&emsp;   <a href="/movie/Drama/${drama.title}/${drama.id}/views">View reviews</a>
	</div>
	</div>
